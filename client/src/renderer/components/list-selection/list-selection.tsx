...
export const ListSelection: React.FC<Props> = ({onSelected}) => {
  ...
  const createNewList = () => {
    onSelected({id: 'new-123123', name: 'test?'});
  };
      ...
      <Grid2 container spacing={1}>
        ...
        <Grid2 size={5}>
          ...
          <TextField
            ...
            size="small"
          />
          <Button variant="contained" color="secondary" onClick={selectExistingList}>
            Continue &rarr;
          </Button>
        </Grid2>
      </Grid2>
